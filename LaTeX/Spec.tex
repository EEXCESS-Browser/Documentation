...
\newcommand{\SECH}{S\raisebox{-0.25em}{\textsmaller[0.5]{E}}CH\xspace}
...
\title{
  EEXCESS--Programming Guide\\[1em]
  \SECH--Browser --- Spezifikation, Konstruktion
}

\author{Prof.~Dr.~Peter~Stöhr}
\date{Version 0.1}
